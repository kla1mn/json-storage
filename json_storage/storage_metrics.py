...
elastic_cluster_health = Gauge(
    'json_storage_elastic_cluster_health',
    'Elastic cluster health status (0=red, 1=yellow, 2=green)',
)
elastic_index_store_size = Gauge(
    'json_storage_elastic_index_store_size_bytes',
...
indexing_pending = Gauge(
    ...
    'Total number of documents pending for indexing',
)
indexing_oldest_age = Gauge(
    'json_storage_indexing_oldest_age_seconds',
    'Age in seconds of the oldest document in the indexing queue',
)
indexing_avg_age = Gauge(
    'json_storage_indexing_avg_age_seconds',
    'Average age of documents in the indexing queue',
)
